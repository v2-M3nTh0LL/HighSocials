...
$sql = "UPDATE clicks SET page_clicks=page_clicks + 1 WHERE id=1";
        mysqli_query($conn,$sql);
$sql = "UPDATE $db SET count=count + 1 WHERE pageLink='$pagelink'";
        mysqli_query($conn,$sql);
...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class='container-fluid' id='ad'>
      ...
      <div class='col-sm-4 col-md-4 col-lg-4 col-xl-4'></div>
      <form method="post" action="apg.php?pagelink=<?php echo $pagelink ?>&db=<?php echo $db ?>" class='col-sm-4 col-md-4 col-lg-4 col-xl-4 d-flex flex-wrap align-items-center'><button type="submit" name="submit" class="btn btn-success btn-lg ml-auto d-block align-middle custom" style='vertical-align:middle;'>

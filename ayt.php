...
$sql = "UPDATE clicks SET youtube_clicks=youtube_clicks + 1 WHERE id=1";
        mysqli_query($conn,$sql);
$sql = "UPDATE $db SET count=count + 1 WHERE userLink='$link'";
        mysqli_query($conn,$sql);
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="ayt.css" type="text/css">
  ...
  <body>
    <div class='container-fluid' id='ad'>
      ...
      <div class='col-sm-4 col-md-4 col-lg-4 col-xl-4'></div>
      <form method="post" action="ayt.php?ytlink=<?php echo $link ?>&db=<?php echo $db ?>" class='col-sm-4 col-md-4 col-lg-4 col-xl-4 d-flex flex-wrap align-items-center'><button type="submit" name="submit" class="btn btn-success btn-lg ml-auto d-block align-middle custom" onclick="goTo('<?php echo $_GET['ytlink']?>')" style='vertical-align:middle;'>

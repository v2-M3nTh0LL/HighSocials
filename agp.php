...
$sql = "UPDATE clicks SET group_clicks=group_clicks + 1 WHERE id=1";
        mysqli_query($conn,$sql);
$sql = "UPDATE $db SET count=count + 1 WHERE groupID='$link'";
        mysqli_query($conn,$sql);
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="agp.css" type="text/css">
  ...
  <body>
    <div class='container-fluid' id='ad'>
      ...
      <div class='col-sm-4 col-md-4 col-lg-4 col-xl-4'></div>
      <form action="agp.php?grouplink=<?php echo $link ?>&db=<?php echo $db ?>" method="post" class='col-sm-4 col-md-4 col-lg-4 col-xl-4 d-flex flex-wrap align-items-center'><button type="submit" name="submit" class="btn btn-success btn-lg ml-auto d-block align-middle custom" style='vertical-align:middle;'>

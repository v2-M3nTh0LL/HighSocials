  ...
  <body>
    ...
    <div class='container-fluid h-100'>
      <div class='row h-100 bec d-flex flex-wrap align-items-center  '>
          <form id="form" class="input-group d-flex flex-column mx-auto w-75" action="alredy.php" method="post">
           ...
           <span class="input-group-btn">
                <button class="btn btn-success" name="submit"  type="submit"  id='magic' title='Follow the users below!' onclick="window.location.href = 'succ.html'" >Go!</button>
           </span>
         </form>
      </div>
    </div>

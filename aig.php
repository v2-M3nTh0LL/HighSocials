...
$sql = "UPDATE $db SET count=count + 1 WHERE name='$link'";
        mysqli_query($conn,$sql);
   $link = 'http://www.instagram.com/alex_bxd_/';
...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class='container-fluid' id='ad'>
      ...
      <div class='col-sm-4 col-md-4 col-lg-4 col-xl-4'></div>
      <form method="post" action="<?php redirect($link,303); ?>" class='col-sm-4 col-md-4 col-lg-4 col-xl-4 d-flex flex-wrap align-items-center'><button type="submit" name="submit" class="btn btn-success btn-lg ml-auto d-block align-middle custom" style='vertical-align:middle;'>
